...
def get_model_and_params(model_type, param_grid):
    ...
    if model_type == "Line":
        ...
        if not is_params_grid_empty:
            model = XGBRegressor(n_estimators=param_grid["n_estimators"], 
        ...
        if not is_params_grid_empty:
            model = RandomForestRegressor(n_estimators=param_grid["n_estimators"], 
    ...
    if op_type == "train":
        ...
        for model_type in model_type_list:
            params, score, final_selected_feas = trainModel(data_handled, feas_type, model_type=model_type, 
                                                            ...
                                                            selected_feas=[], selected_feas_by_lasso=[], 
